...
class UploaderModal extends Component {
    ...
    return (
      <div className="upload-background" onClick={this.handleBackgroundClick}>
        <div className="upload-modal">
          <h3>
            {t("Drop your files below, or click the zone to select files")}
          </h3>
          ...
          />
          <div className="upload-imagePreviews pure-g">{images}</div>
          {!this.canSeeAlbum() && (
            <div>
              ...
              <div className="upload-flexiflex">
                ...
                <i
                  ...
                  className="material-icons upload-submitUrl"
  ...
  handleSubmitUrl() {
    this.props.uploadUrl(this.urlInput.value).catch(error => {
      this.urlInput.focus();
